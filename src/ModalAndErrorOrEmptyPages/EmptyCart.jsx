...
// Empty Cart State Component (Amazon Style - Simplified)
const EmptyCart = () => {

    const navigate = useNavigate();
    return (
        <div className="max-w-4xl mx-auto">
             {/* Main Content: Icon and Message */}
            <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col md:flex-row items-center md:items-start border border-gray-200">
                ...
                <div className="flex-grow text-center md:text-left">
                    <h1 className="text-3xl font-bold text-gray-800 mb-2 border-b border-gray-200 pb-2">Your Shopping Cart is Empty</h1>
                    <p className="text-gray-500 mb-6 text-lg">
                        You have no items in your cart. To buy items, click "Continue Shopping" or explore categories.
                    </p>
                    
                    {/* CTA Button (Amazon Yellow/Orange) */}
                    <button
                    ...
                    <p className="mt-6 text-sm text-gray-400">Sign in to see items you may have saved.</p>
                </div>
            </div>
        </div>
    );
